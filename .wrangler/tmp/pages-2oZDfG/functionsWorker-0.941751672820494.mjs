...
async function onRequestGet2(context) {
  try {
    ...
    const stats = {
      ...
      today: 0,
      uniqueColleges: /* @__PURE__ */ new Set(),
      byCollege: {},
      byLevel: {},
      byInterest: {},
      byHeardFrom: {}
    ...
    const formatForCharts = /* @__PURE__ */ __name((obj) => Object.entries(obj).map(([name, value]) => ({ name, value })), "formatForCharts");
    const chartData = {
...
// ../.wrangler/tmp/pages-2oZDfG/functionsRoutes-0.08742712128805641.mjs
var routes = [
  {
...
// ../../home/ubuntu/.nvm/versions/node/v22.22.1/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../home/ubuntu/.nvm/versions/node/v22.22.1/lib/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../../home/ubuntu/.nvm/versions/node/v22.22.1/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../home/ubuntu/.nvm/versions/node/v22.22.1/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-VjULLQ/middleware-insertion-facade.js
...
// ../../home/ubuntu/.nvm/versions/node/v22.22.1/lib/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-VjULLQ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.941751672820494.mjs.map
